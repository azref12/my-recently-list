...
def kdrama_list (request):
    
        mymodels = kdrama
        myserializer = KdramaSerializers

        if request.method == 'GET':
            
                mymodels = kdrama.objects.all()
                myserializer = KdramaSerializers (mymodels, many=True)
